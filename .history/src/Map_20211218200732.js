...
function Map({ stanice, foundedBus, firstLocation, setFirstLocation, secondLocation, setSecondLocation,  nearestA, nearestB }) {
    ...
    const map_style = 'mapbox://styles/mapbox/light-v10' //mapbox://styles/tarikbesic/ckvgxnb320ene14oaqx6umnf8
    const mapRef = useRef()
    ...
    const matchRoute = async (e) => { //Bus route
        const url = "https://api.mapbox.com/matching/v5/mapbox/cycling/" + e + "?geometries=geojson&overview=full&tidy=true&access_token=" + map_key;
