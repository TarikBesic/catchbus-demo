...
function Map({ stanice, busevi, foundedBus, firstLocation, setFirstLocation, secondLocation, setSecondLocation, nearestA, nearestB }) {
    ...
    }, [foundedBus, firstLocation, secondLocation])
