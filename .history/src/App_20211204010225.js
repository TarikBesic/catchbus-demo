...
function App() {
  ...
  return (
    <div className="app">
      <div className="map">
        <Map ready = {ready} stanice = {stanice} foundedBus = {foundedBus} firstLocation = {firstLocation} setFirstLocation = {setFirstLocation} secondLocation = {secondLocation} nearestA = {nearestA} nearestB = {nearestB} />
      </div>
    </div>
  );
}
