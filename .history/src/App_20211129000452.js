...
function App() {
  ...
  return (
    <div className="app">
      <div className="map">
        <Map stanice = {stanice} busevi = {busevi} foundedBus = {foundedBus} firstLocation = {firstLocation} setFirstLocation = {setFirstLocation} secondLocation = {setSecondLocation}  />
      </div>
    </div>
  );
}
